...
@objc public class DateTimePicker: UIView {
    ...
    private func configureView() {
        ...
        doneButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 21)
        ...
        doneButton.topAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -10 - 60 - 10).isActive = true
